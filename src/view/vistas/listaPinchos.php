			...
			<ul class= "list-inline ">
				...
				while ($i <= 12){?>
					<li class= "column col-lg-2 col-md-2 col-sm-4 col-xs-4 col-md-offset-1">
						...
						<a href="index.php?controller=pincho&action=consultaPincho"><img src="./resources/img/pinchos/pincho.jpg" alt="Imagen del Pincho" class="img-thumbnail img-responsive"></a>
						<div class="caption">
